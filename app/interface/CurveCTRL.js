...
function (THREE,$,shapeData) {
	...
	var CurveCTRL = function(args){
		...
		// Interface.Interface.CurveCTRL.isDrawing = false;

		// this.staticDrawing = function(){
		// 	return Interface.Interface.CurveCTRL.isDrawing;
		// };
