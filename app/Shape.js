define(["THREE", "ModelGenerator/Generator", "ModelGenerator/PerlinNoise"], function(THREE, Flower, noise){
  ...
  //       this.object = new THREE.Mesh(pGeom,pMat);
		...
		// this.object.prnt.scale.x = 100;
		// this.object.prnt.scale.y = 100;
		// this.object.prnt.scale.z = 100;
