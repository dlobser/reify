sc1 = {
    ...
    setup:function(){
        ...
        b.init();
        flower = new Flower({layers:200,curveDetail:600,resampleDetail:600,balls:b,scale:100,gridDetail:80});
        flower.init();
...
function Flower(params){
    ...
    this.turtle = function(){
        ...
        for(var i = 0 ; i < spiral.geometry.vertices.length-1 ; i++){
            ...
            kid.position.x = Math.sin((i*pi*4.1/this.resampleDetail)*this.resampleDetail/10)*.01;
            // kid.position.z = Math.cos((i*pi*4/this.resampleDetail)*this.resampleDetail/20)*.02;
